      ...
      <main className="container mx-auto px-4 pt-24 pb-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          >
            <Card className="border-green-500/20 shadow-2xl shadow-green-500/10">
              <CardHeader className="bg-gradient-to-r from-green-900/20 to-blue-900/20 border-b flex justify-center">
          ...
          >
            ...
            <Card className="border-purple-500/20 shadow-xl shadow-purple-500/10">
              <CardHeader className="bg-gradient-to-r from-purple-900/20 to-pink-900/20 border-b flex justify-center">
                <CardTitle className="flex items-center gap-2">
        ...
        >
          <Card className="border-blue-500/20 shadow-2xl shadow-blue-500/10">
            <CardHeader className="bg-gradient-to-r from-blue-900/20 to-purple-900/20 border-b flex justify-center">
              <CardTitle className="flex items-center gap-2">
